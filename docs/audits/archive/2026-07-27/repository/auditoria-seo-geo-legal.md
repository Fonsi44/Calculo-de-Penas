...
| 7 | 8 categorías blog + 8 servicios "NEUTRAL/nunca rastreado" en GSC | `/blog/{categoria}`, `/servicios-juridicos/{slug}` | **Media** | SEO técnico | Solicitar indexación en GSC (cuota ~10/día) según priorización de `docs/audits/archive/2026-08-06/indexacion-monitorizacion.md` | Bajo | No (paralelo) |

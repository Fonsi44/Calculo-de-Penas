...
| **GSC Indexación (post-deploy)** | `docs/audits/archive/2026-08-06/indexacion-monitorizacion.md` | Desde 2026-07-04 | ✅ Referencia |
...
- **Evidencia:** `docs/audits/archive/2026-08-06/indexacion-monitorizacion.md` muestra que desde el deploy del 2026-07-04, solo `/` está indexada (PASS, último rastreo 2026-06-30). **16 URLs comerciales + 8 categorías de blog permanecen "Pendiente" sin rastreo** (fecha 1970-01-01).
...
- [ ] **GSC → Inspección de URLs → solicitar indexación** de las 10 URLs comerciales Nivel 1 (ver `docs/audits/archive/2026-08-06/indexacion-monitorizacion.md`): `/servicios-juridicos`, `/servicios-juridicos/derecho-laboral`, `/derecho-penal`, `/abogados-en-nacaome`, `/abogados-en-choluteca`, etc.
...
| `docs/audits/archive/2026-08-06/auditoria-bing-webmaster-2026-07-08.md` | **Este informe** |
...
2. **Monitor de indexación automática** — ampliar `scripts/auditar-indexacion-prioritaria.mjs` para que consulte la API de inspección de URLs de GSC y actualice `docs/audits/archive/2026-08-06/indexacion-monitorizacion.md` automáticamente (actualmente manual).

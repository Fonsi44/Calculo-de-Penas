...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'es_HN',
    type: 'website',
    images: [{ url: `${site.url}/og-image.webp`, width: 1200, height: 630, alt: `${site.name} — Términos y Condiciones` }],
  },
};
  ...
  return (
    ...
    >
      <LegalCallout variant="warning">
        ...
        La información publicada en este sitio web es{' '}
        <strong className="font-semibold">orientativa</strong>. NO constituye
        asesoramiento legal, NO sustituye la consulta con un abogado
        colegiado en Honduras, y NO genera por sí sola una relación
        abogado-cliente. Cada caso requiere análisis individual por un
      ...
      <LegalSection number="2" title="Descripción del servicio">
        <p>
          La Plataforma es el sitio corporativo de Pineda y Asociados:
          información sobre el despacho, servicios jurídicos, contenidos
          del blog, preguntas frecuentes y formularios de contacto o
          solicitud de evaluación inicial confidencial.
        </p>
        <p>
          La Plataforma NO emite dictámenes periciales, NO realiza
          calificación jurídica de hechos ni sustituye el análisis
      ...
      <LegalSection number="3" title="Uso aceptable">
        ...
        <LegalList
          items={[
            ...
            'Intentar acceder a sistemas, datos o cuentas ajenas.',
      ...
      <LegalSection number="4" title="Propiedad intelectual">
        <p>
          La Plataforma, su código fuente, diseño, marca y contenidos
      ...
      <LegalSection number="5" title="Limitación de responsabilidad">
        ...
        <LegalList
          items={[
            'Decisiones adoptadas únicamente a partir de contenidos informativos del sitio.',
            'Variaciones en la interpretación jurisprudencial o cambios normativos.',
            'Errores materiales en contenidos publicados a pesar de su verificación.',
            'Daños directos, indirectos, incidentales o consecuentes derivados del uso o imposibilidad de uso del servicio.',
          ]}
        />
      </LegalSection>

      <LegalSection number="6" title="Enlaces a sitios de terceros">
        <p>
      ...
      <LegalSection number="7" title="Modificaciones">
        <p>
          El bufete se reserva el derecho de modificar los presentes
          Términos en cualquier momento. Los cambios se publicarán en
          esta misma URL con la fecha de actualización.
        </p>
      </LegalSection>

      <LegalSection number="8" title="Ley aplicable y jurisdicción">
        <p>

  ...
  return (
    <>
      ...
      <BlogHighlights
        ...
        eyebrow="Guías para Concepción de María y Choluteca"
        title="Recursos legales de interés para la zona fronteriza"
        subtitle="Guías prácticas sobre defensa penal, derecho de familia, laboral y civil para residentes de Concepción de María y el departamento de Choluteca."

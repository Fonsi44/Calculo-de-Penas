...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'es_HN',
    type: 'website',
    images: [{ url: `${site.url}/og-image.webp`, width: 1200, height: 630, alt: `${site.name} — Aviso Legal` }],
  },
};
    ...
    >
      <LegalSection number="1" title="Datos identificativos del titular">
        ...
        <LegalList
          items={[
            ...
            <>Actividad: Bufete jurídico de servicios legales (asesoría, consultoría y litigio en las principales ramas del derecho).</>,
          ]}
        />
      </LegalSection>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          '@type': 'WebPage',
          '@id': `${absoluteUrl('/aviso-legal')}#webpage`,
          url: absoluteUrl('/aviso-legal'),
          name: 'Aviso Legal | Pineda y Asociados',
          description: 'Aviso legal e identificación del titular del sitio web de Pineda y Asociados, bufete jurídico en Nacaome, Valle, Honduras.',
          inLanguage: 'es-HN',

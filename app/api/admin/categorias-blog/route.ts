...
export async function POST(request: Request) {
  try {
    ...
    await logAudit({ usuarioId: auth.userId, accion: 'categoria_blog_created' as AuditoriaAccion, recurso: 'categoria_blog', recursoId: cat.id, metadata: { slug: cat.slug }, request });

...
const PUBLIC_ROUTES: Array<{ path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]['changeFrequency']; lastModified?: Date }> = [
  ...
  { path: '/hodurenos-en-espana', priority: 0.9, changeFrequency: 'monthly' },
  { path: '/hodurenos-en-espana/gestion-documental-y-legalizacion', priority: 0.8, changeFrequency: 'monthly' },
  { path: '/hodurenos-en-espana/actos-notariales-internacionales', priority: 0.8, changeFrequency: 'monthly' },
  { path: '/hodurenos-en-espana/asuntos-civiles-y-familiares-desde-el-extranjero', priority: 0.8, changeFrequency: 'monthly' },

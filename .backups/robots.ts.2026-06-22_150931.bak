 ...
 *   - Rastreo permitido para TODOS los bots de IA (GPTBot, ClaudeBot,
 *     PerplexityBot, Google-Extended, Applebot-Extended, etc.) para máxima
 *     visibilidad en buscadores tradicionales y generativos (GEO/LLM SEO).
 *   - Rutas privadas (/intranet/, /api/) bloqueadas para todos.
 *
 * Política actual (Jun 2026): rastreo permitido para TODOS los bots,
 * incluidos bots de IA (GPTBot, ClaudeBot, PerplexityBot, etc.), para
 * máxima visibilidad en buscadores tradicionales y generativos (GEO/LLM SEO).
 * Solo se bloquean rutas privadas (/intranet/, /api/).
 *

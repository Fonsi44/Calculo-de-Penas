        ...
        const inner = (
          <div className="flex items-start gap-3 p-4 rounded-md bg-surface border border-border-light hover:border-accent/50 transition-colors h-full">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[10px] font-bold uppercase tracking-wider text-text-muted">{it.label}</p>
              <p className="text-[13px] font-semibold text-text leading-tight mt-0.5 tabular-nums">{it.value}</p>
            </div>
          </div>
        );

...
export const delitos = pgTable('delitos', {
  ...
  tipoPenaPrincipal: varchar('tipo_pena_principal', { length: 50 }),
  tienePrision: boolean('tiene_prision').default(false),
  prisionMinValor: integer('prision_min_valor'),
  prisionMaxValor: integer('prision_max_valor'),
  prisionUnidad: varchar('prision_unidad', { length: 20 }).default('meses'),
  tieneMulta: boolean('tiene_multa').default(false),
  multaMinValor: integer('multa_min_valor'),
  multaMaxValor: integer('multa_max_valor'),
  multaUnidad: varchar('multa_unidad', { length: 50 }),
  multaDescripcionLegal: text('multa_descripcion_legal'),
  penaAlternativaTipo: varchar('pena_alternativa_tipo', { length: 50 }),
  penaAlternativaMinValor: integer('pena_alternativa_min_valor'),
  penaAlternativaMaxValor: integer('pena_alternativa_max_valor'),
  penaAlternativaUnidad: varchar('pena_alternativa_unidad', { length: 20 }),
  inhabilitacionMinValor: integer('inhabilitacion_min_valor'),
  inhabilitacionMaxValor: integer('inhabilitacion_max_valor'),
  inhabilitacionUnidad: varchar('inhabilitacion_unidad', { length: 50 }),
  reglasEspecialesPena: text('reglas_especiales_pena'),
  observacionesPena: text('observaciones_pena'),
  estadoVerificacionPena: varchar('estado_verificacion_pena', { length: 30 }).default('pendiente_revision'),
}, (table) => ({

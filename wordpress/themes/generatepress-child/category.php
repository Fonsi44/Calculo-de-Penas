<?php
/**
 * Template: Archivo de Categoría
 * Listado de posts por categoría con breadcrumbs, header, grid y paginación.
 *
    ...
    <div class="post-grid-wrap">
        ...
        <?php else : ?>
            <div class="empty-state">
                <p>No hay artículos publicados en esta categoría aún.</p>

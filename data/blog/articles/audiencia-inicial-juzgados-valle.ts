...
<p>Honduras aplica desde 2002 el <strong>sistema acusatorio oral y público</strong> del <strong>Código Procesal Penal (Decreto 9-99-E)</strong>. El art. 447 CPP derogó el antiguo Código de Procedimientos Penales de 1984; el proceso penal vigente es transparente y de acceso público, no el modelo escrito derogado. El art. 1 CPP exige juicio previo, oral y público; el art. 308 CPP establece la publicidad del juicio y el art. 310 CPP que el debate se desarrolla oralmente.</p>

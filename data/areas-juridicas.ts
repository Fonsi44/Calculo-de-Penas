...
export type Subservicio = {
  titulo: string;
  descripcion: string;
  /** Términos del catálogo maestro u otras consultas que deben encontrar este servicio. */
  aliases?: string[];
};
...
export const areasGenerales: AreaStandalone[] = [
  {
    ...
    subservicios: [
      ...
      { titulo: 'Régimen de visitas y convivencia', descripcion: 'Fijación, modificación y ejecución de incumplimiento del régimen.', aliases: ['custodia cuidado personal', 'régimen de comunicación'] },
      { titulo: 'Pensión de alimentos', descripcion: 'Demanda, cuantificación, ejecución y revisión por cambio de circunstancias.', aliases: ['demandas de aumento', 'demandas de reducción', 'pensiones alimenticias', 'ejecución de pensiones', 'ejecución de pensiones alimenticias'] },
      { titulo: 'Reconocimiento de unión de hecho', descripcion: 'Procedimiento notarial o judicial para reconocimiento de derechos patrimoniales.', aliases: ['reconocimiento declaración e'] },
      { titulo: 'Adopción nacional', descripcion: 'Tramitación ante SENAF, IHNFA y Juzgados de Familia con acompañamiento integral.', aliases: ['adopciones nacionales e', 'adopciones nacionales e internacionales'] },
      ...
      { titulo: 'Sucesiones intestadas y testamentarias', descripcion: 'Declaratoria de herederos, inventario, avalúo, partición y adjudicación.', aliases: ['procesos de herencias', 'partición judicial', 'partición extrajudicial', 'renuncia o repudiación'] },
      ...
      { titulo: 'Violencia intrafamiliar y medidas de protección', descripcion: 'Solicitud urgente de medidas cautelares ante Juzgados y Juzgados de Paz.', aliases: ['procesos penales'] },
      { titulo: 'Emancipación judicial de menores', descripcion: 'Procedimiento especial ante Juez de Familia.' },
      { titulo: 'Curatela y tutela', descripcion: 'Designación, rendición de cuentas y remoción.', aliases: ['procesos de tutela'] },
      { titulo: ' Filiación y declaración de paternidad', descripcion: 'Investigación judicial de paternidad con prueba de ADN.', aliases: ['demandas de reconocimiento'] },
      ...
      { titulo: 'Separaciones de cuerpos y de bienes', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['separación de cuerpos'] },
      { titulo: 'Pensiones alimenticias (fijación inicial de la cuantía, aumento, reducción y reclamos de atrasos)', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['pensiones alimenticias'] },
      { titulo: 'Ejecución de pensiones alimenticias', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['ejecución de pensiones'] },
      { titulo: 'Demandas de impugnación de paternidad', descripcion: 'Juicio de impugnación de filiación cuando procede conforme al Código de Familia. Evaluación inicial confidencial.', aliases: ['impugnación de paternidad'] },
      { titulo: 'Adopciones nacionales e internacionales', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['adopciones nacionales e'] },
      { titulo: 'Constitución de patrimonio familiar sobre bienes inmuebles (bienes inembargables)', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['patrimonio familiar'] },
      { titulo: 'Autorizaciones judiciales para la salida de menores del país', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['autorizaciones judiciales para'] },
      { titulo: 'Autorizaciones notariales de viaje para menores de edad', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['autorizaciones notariales'] },
    ],
    faqs: [
  ...
  },
  {
    ...
    subservicios: [
      ...
      { titulo: 'Riesgos profesionales y accidente de trabajo', descripcion: 'Reclamación ante el IHSS y la empresa. Indemnización por muerte, incapacidad o invalidez.', aliases: ['reclamaciones por accidentes'] },
      ...
      { titulo: 'Conciliación prejudicial', descripcion: 'Comparecencia ante el Inspector del Trabajo y el Tribunal de Conciliación.', aliases: ['comparecencia en audiencias'] },
      ...
      { titulo: 'Cálculo, revisión y auditoría de liquidaciones laborales', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['cálculo revisión'] },
      { titulo: 'Reclamos salariales, salarios caídos y pago de horas extras', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['salarios caídos'] },
      { titulo: 'Demandas por discriminación en el trabajo', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['demandas por discriminación'] },
      { titulo: 'Elaboración y aprobación de reglamentos internos de trabajo ante la autoridad competente', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['reglamentos internos'] },
      { titulo: 'Auditoría laboral preventiva para evitar demandas de trabajadores', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['auditoría laboral'] },
      { titulo: 'Cumplimiento laboral normativo general (seguridad social, leyes de alivio de deuda, etc.)', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['cumplimiento laboral normativo'] },
      { titulo: 'Asesoría legal en la implementación de teletrabajo y jornadas mixtas', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['teletrabajo'] },
      { titulo: 'Interposición y contestación de demandas laborales en juzgados de letras del trabajo', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['interposición y contestación'] },
      { titulo: 'Tramitación de reclamos administrativos ante la Secretaría de Trabajo (SETRACO)', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['setraco'] },
      { titulo: 'Mediación y resolución de conflictos colectivos con sindicatos', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['conflictos colectivos'] },
    ],
    faqs: [
  ...
  },
  {
    ...
    subservicios: [
      ...
      { titulo: 'Arrendamiento de vivienda y local comercial', descripcion: 'Contrato, garantía, cobro de rentas y desahucio.', aliases: ['redacción y ejecución', 'procesos de inquilinato'] },
      { titulo: 'Donación entre vivos', descripcion: 'Acto notarial con efectos civiles y registro en el Instituto de la Propiedad.' },
      { titulo: 'Permuta y cesión de derechos', descripcion: 'Tramitación y registro.', aliases: ['redacción de contratos'] },
      { titulo: 'Hipoteca y garantía mobiliaria', descripcion: 'Constitución, modificación y ejecución.', aliases: ['constitución inscripción'] },
      { titulo: 'Mandato y poder notarial', descripcion: 'Poder general, especial, judicial o administrativo.' },
      { titulo: 'Sociedad civil y de responsabilidad limitada', descripcion: 'Constitución y reformas.', aliases: ['procesos de responsabilidad'] },
      ...
      { titulo: 'Servidumbres', descripcion: 'Constitución, modificación o defensa judicial.', aliases: ['constitución de servidumbres', 'extinción o cancelación'] },
      { titulo: 'Reivindicación de inmuebles', descripcion: 'Acción posesoria y de dominio.', aliases: ['demandas de reivindicación'] },
      { titulo: 'Cobro judicial de deudas', descripcion: 'Vía ejecutiva, monitoria o declarativa con título.' },
      { titulo: 'Daños y perjuicios', descripcion: 'Responsabilidad civil contractual y extracontractual.', aliases: ['demandas por daños'] },
      { titulo: 'Responsabilidad civil por accidente de tránsito', descripcion: 'Reclamación al seguro, demanda civil y ejecución.' },
      { titulo: 'Medición y deslinde', descripcion: 'Procedimiento ante Catastro y Juzgados.', aliases: ['procesos de deslinde'] },
      { titulo: 'Protocolización de documentos', descripcion: 'Acto notarial de incorporación al protocolo.', aliases: ['autenticaciones notariales'] },
      { titulo: 'Redacción, revisión y firma de todo tipo de contratos civiles', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['redacción revisión'] },
      { titulo: 'Demandas judiciales por incumplimiento de contratos', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['demandas judiciales'] },
      { titulo: 'Procesos judiciales para la resolución o rescisión contractual', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['procesos judiciales para'] },
      { titulo: 'Redacción y ejecución de contratos de arrendamiento (locación)', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['redacción y ejecución'] },
      { titulo: 'Redacción y formalización de contratos de comodato (préstamo de uso)', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['comodato'] },
      { titulo: 'Redacción de contratos de permuta de bienes', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['redacción de contratos'] },
      { titulo: 'Elaboración de contratos de transacción para evitar litigios judiciales', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['elaboración de contratos'] },
      { titulo: 'Constitución, regulación y extinción del derecho de Usufructo (uso y disfrute de una…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['usufructo'] },
      { titulo: 'Trámite de conversión de dominio útil a Dominio Pleno ante corporaciones municipales…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['trámite de conversión'] },
      { titulo: 'Inscripción y registro de Títulos de Dominio Pleno ante el Instituto de la Propiedad (IP)', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['inscripción y registro'] },
      { titulo: 'Saneamiento legal de propiedades con problemas registrales o catastrales', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['saneamiento legal'] },
      { titulo: 'Demandas de Títulos Supletorios para registrar propiedades sin antecedente inscrito', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['títulos supletorios'] },
      { titulo: 'Rectificación de áreas, medidas y colindancias ante el Instituto de la Propiedad (IP)', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['rectificación de áreas'] },
      { titulo: 'Demandas interdictales para retener la posesión de un inmueble ante perturbaciones', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['demandas interdictales para'] },
      { titulo: 'Interposición de procesos ejecutivos (con base en títulos ejecutivos)', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['interposición de procesos'] },
      { titulo: 'Solicitud, ejecución y levantamiento de embargos preventivos y definitivos sobre…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['solicitud ejecución'] },
      { titulo: 'Ejecución forzosa de sentencias judiciales', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['ejecución forzosa'] },
      { titulo: 'Resolución de conflictos civiles generales entre particulares (vecindad, linderos)', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['resolución de conflictos'] },
      { titulo: 'Procesos de herencias (abintestato/sin testamento y testamentarias)', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['procesos de herencias'] },
      { titulo: 'Redacción, estructuración y autorización notarial de Testamentos (abiertos y cerrados)', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['redacción estructuración'] },
      { titulo: 'Partición judicial de bienes hereditarios entre coherederos', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['partición judicial'] },
      { titulo: 'Partición extrajudicial o amigable de bienes hereditarios', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['partición extrajudicial'] },
      { titulo: 'Renuncia o repudiación de herencias de forma legal', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['renuncia o repudiación'] },
      { titulo: 'Autorización y protocolo de escrituras públicas de toda índole', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['autorización y protocolo'] },
      { titulo: 'Elaboración de actas notariales de fe de hechos, notificaciones o requerimientos', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['elaboración de actas'] },
      { titulo: 'Celebración, formalización e inscripción de matrimonios civiles ante notario', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['celebración formalización e'] },
      { titulo: 'Constitución, inscripción y cancelación de hipotecas y garantías', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['constitución inscripción'] },
    ],
    faqs: [
  ...
  },
  {
    ...
    subservicios: [
      ...
      { titulo: 'Disolución y liquidación', descripcion: 'Procedimiento legal y registral.', aliases: ['procesos de liquidación'] },
      { titulo: 'Contratos mercantiles', descripcion: 'Suministro, distribución, franquicia, joint venture, agencia, concesión y licencia.', aliases: ['redacción y revisión', 'redacción de contratos', 'estructuración de contratos'] },
      { titulo: 'Gobierno corporativo', descripcion: 'Protocolos familiares, junta directiva, comités de auditoría.', aliases: ['asesoría en gobierno'] },
      ...
      { titulo: 'Fideicomiso mercantil', descripcion: 'Constitución y operación.', aliases: ['inscripción de empresas'] },
      { titulo: 'Formalización y constitución de Comerciante Individual', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['comerciante individual'] },
      { titulo: 'Constitución de Sociedades Unipersonales (sociedades de capital con un solo accionista…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['sociedades unipersonales'] },
      { titulo: 'Tramitación, obtención y actualización del Registro Tributario Nacional (RTN) de la…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['tramitación obtención'] },
      { titulo: 'Constitución de empresas bajo el Régimen Mipyme (para gozar de beneficios de exención…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['régimen mipyme'] },
      { titulo: 'Elaboración de acuerdos, pactos de socios y alianzas comerciales (Joint Ventures)', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['elaboración de acuerdos'] },
      { titulo: 'Redacción de actas de asambleas ordinarias y extraordinarias de socios o accionistas', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['redacción de actas'] },
      { titulo: 'Procesos de modificación de estatutos sociales (aumento o reducción de capital, cambio…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['procesos de modificación'] },
      { titulo: 'Ejecución de Due Diligence (auditoría e investigación legal profunda de empresas para…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['ejecución de due'] },
      { titulo: 'Asesoría jurídica para comercio electrónico, redacción de términos y condiciones y…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['comercio electrónico'] },
      { titulo: 'Defensa legal en disputas y litigios entre socios o accionistas', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['defensa legal'] },
      { titulo: 'Cobro judicial y extrajudicial de cartera morosa corporativa', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['cobro judicial'] },
      { titulo: 'Gestión, cobro y defense basados en títulos valores', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['gestión cobro'] },
      { titulo: 'Redacción, endoso y ejecución judicial de pagarés', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['redacción endoso'] },
      { titulo: 'Redacción, aceptación y ejecución judicial de letras de cambio', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['redacción aceptación'] },
    ],
    faqs: [
  ...
  },
  {
    ...
    subservicios: [
      ...
      { titulo: 'Defensa del usuario financiero', descripcion: 'Quejas ante la CNBS y la Defensoría del Cliente Financiero.', aliases: ['defensa legal'] },
      { titulo: 'Cobro judicial bancario', descripcion: 'Juicio ejecutivo cambiario y declarativo.' },
      { titulo: 'Garantías mobiliarias y prendarias', descripcion: 'Registro y ejecución.', aliases: ['garantías prendarias'] },
      { titulo: 'Fideicomiso de garantía', descripcion: 'Constitución y operación.' },
      { titulo: 'Contratos de leasing y factoraje', descripcion: 'Asesoría y litigio.', aliases: ['estructuración de contratos'] },
      ...
      { titulo: 'Interposición de denuncias y recursos ante la Comisión Nacional de Bancos y Seguros (CNBS)', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['interposición de denuncias'] },
    ],
    faqs: [
  ...
  },
  {
    ...
    subservicios: [
      ...
      { titulo: 'Contratos del Estado', descripcion: 'Licitación, concurso, contratación directa y excepciones.', aliases: ['asesoría preparación', 'defensa del valor'] },
      ...
      { titulo: 'Impugnaciones de actos administrativos estatales y juicios de lo…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['impugnaciones de actos'] },
      { titulo: 'Defensa en procedimientos sancionadores y multas aplicadas por entes reguladores…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['defensa en procedimientos'] },
      { titulo: 'Trámites, gestiones y cabildeo legal ante instituciones públicas, ministerios del…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['trámites gestiones'] },
      { titulo: 'Obtención de licencias, permisos de operación municipales y registros estatales diversos', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['obtención de licencias'] },
      { titulo: 'Interposición de juicios de lo Contencioso-Administrativo ante los tribunales de justicia', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['interposición de juicios'] },
      { titulo: 'Defensa legal de empleados públicos bajo el régimen y estatuto de Servicio Civil ante…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['defensa legal'] },
    ],
    faqs: [
  ...
  },
  {
    ...
    subservicios: [
      ...
      { titulo: 'Importación temporal', descripcion: 'Régimen suspensivo de derechos.', aliases: ['tramitación y gestión'] },
      ...
      { titulo: 'Impugnación de reparos fiscales aduaneros, ajustes de valor y multas por declaraciones…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['impugnación de reparos'] },
      { titulo: 'Defensa legal y recursos contra procesos de decomiso de mercancías en aduanas…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['defensa legal'] },
      { titulo: 'Asesoría legal integral para agencias aduaneras, consolidadoras de carga y…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['asesoría legal integral'] },
    ],
    faqs: [
  ...
  },
  {
    ...
    subservicios: [
      ...
      { titulo: 'Buenas Prácticas de Manufactura (BPM)', descripcion: 'Implementación y auditoría.', aliases: ['tramitación del certificado'] },
      ...
      { titulo: 'Tramitación y renovación de Licencias Sanitarias para el funcionamiento de…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['tramitación y renovación'] },
      { titulo: 'Gestión y obtención de Registros Sanitarios para la importación y comercialización de…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['gestión y obtención'] },
      { titulo: 'Obtención del Certificado de Libre Venta (CLV) requerido para la exportación de…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['libre venta'] },
    ],
    faqs: [
  ...
  },
  {
    ...
    subservicios: [
      ...
      { titulo: 'Residencia temporal', descripcion: 'Por vínculo familiar, trabajo, inversión o estudios.', aliases: ['obtención de permisos'] },
      ...
      { titulo: 'Naturalización ordinaria', descripcion: 'Después de 7 años de residencia.', aliases: ['procesos de naturalización'] },
      ...
      { titulo: 'Gestión de residencias legales en el país (bajo categorías de inversionistas,…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['gestión de residencias'] },
      { titulo: 'Trámites generales de regularización para ciudadanos extranjeros radicados en Honduras', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['trámites generales'] },
      { titulo: 'Gestión, tramitación y defensa de visas consultadas para ciudadanos de países con…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['visas consultadas'] },
    ],
    faqs: [
  ...
  },
  {
    ...
    subservicios: [
      ...
      { titulo: 'Patentes de invención', descripcion: 'Examen de fondo, redacción de reivindicaciones y defensa.', aliases: ['registro de patentes'] },
      ...
      { titulo: 'Derechos de autor', descripcion: 'Obras literarias, artísticas, musicales, software, audiovisuales.', aliases: ['registro de derechos'] },
      ...
      { titulo: 'Redacción de acuerdos de confidencialidad, no competencia y protección de secretos…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['secretos industriales'] },
      { titulo: 'Litigios mercantiles y penales por piratería, falsificación de productos y competencia…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['litigios mercantiles'] },
    ],
    faqs: [
  ...
  },
  {
    ...
    subservicios: [
      ...
      { titulo: 'Regímenes simplificados y especiales', descripcion: 'SAR-Fácil, régimen simplificado del ISV y otros.', aliases: ['planificación fiscal corporativa'] },
      ...
      { titulo: 'Beneficios fiscales en zonas libres', descripcion: 'Asesoría y cumplimiento.', aliases: ['tramitación de exoneraciones'] },
      { titulo: 'Exoneraciones y exenciones', descripcion: 'Por actividad, sector o región.', aliases: ['asesoría fiscal integral'] },
      { titulo: 'Régimen de retención y percepción', descripcion: 'Asesoría operativa.' },
      { titulo: 'Impugnación de reparos fiscales, auditorías e imposición de impuestos ante el Servicio…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['impugnación de reparos'] },
    ],
    faqs: [
  ...
  },
  {
    ...
    subservicios: [
      ...
      { titulo: 'Manejo de residuos sólidos y peligrosos', descripcion: 'Cumplimiento del Reglamento.', aliases: ['gestión de permisos'] },
      { titulo: 'Bosques y áreas protegidas', descripcion: 'Aprovechamiento forestal, zonas de amortiguamiento.' },
      { titulo: 'Sanciones ambientales', descripcion: 'Defensa y recurso.', aliases: ['obtención de dictámenes'] },
  ...
  },
  {
    ...
    subservicios: [
      ...
      { titulo: 'Arbitraje ad hoc', descripcion: 'Reglas de procedimiento y selección de árbitros.', aliases: ['representación legal'] },
      ...
      { titulo: 'Mediación privada', descripcion: 'Con efectos de cosa juzgada una vez cumplida.', aliases: ['negociación mediación'] },
      ...
      { titulo: 'Redacción de cláusulas compromisorias y convenios arbitrales para contratos…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['cláusulas compromisorias'] },
    ],
    faqs: [
  ...
  grupos: [
    ...
    },
    {
      ...
      subservicios: [
        ...
        { titulo: 'Pago de reparación civil', descripcion: 'Negociación y efectos sobre la pena.', aliases: ['acuerdos de reparación'] },
      ...
      { titulo: 'Gestión de salidas alternas al proceso', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['gestión de salidas'] },
      { titulo: 'Sustitución y reemplazo de penas', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['sustitución y reemplazo'] },
      { titulo: 'Defensa y reducción de multas penales', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['defensa y reducción'] },
      { titulo: 'Representación en infracciones menores', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['representación en infracciones'] },
    ],
      faqs: [
    ...
    },
    {
      ...
      subservicios: [
        ...
        { titulo: 'Tráfico y explotación sexual de menores', descripcion: 'Defensa y reparación.', aliases: ['menores como víctimas'] },
      ...
      { titulo: 'Aplicación y vigilancia del principio del interés superior del niño', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['aplicación y vigilancia'] },
    ],
      faqs: [
    ...
    },
    {
      ...
      subservicios: [
        ...
        { titulo: 'Juicio oral', descripcion: 'Defensa en debate probatorio, alegatos de apertura y clausura.', aliases: ['audiencia de juicio'] },
      ...
      { titulo: 'Acompañamiento en detención policial inmediata 24/7', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['acompañamiento en detención'] },
      { titulo: 'Declaraciones e interrogatorios iniciales', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['declaraciones e interrogatorios'] },
      { titulo: 'Declaraciones ante la autoridad judicial', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['declaraciones ante la'] },
      { titulo: 'Solicitud de medidas sustitutivas a la prisión preventiva', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['solicitud de medidas'] },
      { titulo: 'Defensa técnica contra la imposición de prisión preventiva', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['defensa técnica contra'] },
      { titulo: 'Planteamiento de incidentes procesales y excepciones legales', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['planteamiento de incidentes'] },
      { titulo: 'Vigilancia de garantías constitucionales en registros domiciliarios y capturas', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['vigilancia de garantías'] },
    ],
      faqs: [
    ...
    },
    {
      ...
      subservicios: [
        ...
        { titulo: 'Casación', descripcion: 'Ante la Sala de lo Penal de la CSJ.', aliases: ['recursos de casación'] },
        ...
        { titulo: 'Amparo constitucional', descripcion: 'Por violación de derechos fundamentales.', aliases: ['recursos de amparo'] },
        { titulo: 'Habeas corpus', descripcion: 'Por detención ilegal o prisión preventiva desproporcionada.', aliases: ['acciones de habeas'] },
    ...
    },
    {
      ...
      subservicios: [
        ...
        { titulo: 'Defensa corporativa', descripcion: 'Personas jurídicas y administradores.', aliases: ['diseño de defensa'] },
        ...
        { titulo: 'Análisis jurisprudencial', descripcion: 'Búsqueda y aplicación de precedentes.', aliases: ['preparación análisis', 'análisis profundo'] },
      ...
      { titulo: 'Constitución de acusador privado', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['constitución de acusador'] },
      { titulo: 'Gestión de salidas alternas al proceso', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['gestión de salidas'] },
    ],
      faqs: [
    ...
    },
    {
      ...
      { titulo: 'Gestión de beneficios penitenciarios', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['gestión de beneficios'] },
      { titulo: 'Solicitud de reducción de pena', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['solicitud de reducción'] },
      { titulo: 'Tramitación de la extinción de la responsabilidad penal', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['tramitación de la'] },
    ],
      faqs: [
  ...
  subareas: [
    {
      ...
      color: 'primary',
      respuestaDirecta:
        'Pineda y Asociados gestiona desde Honduras apostilla, legalización, antecedentes penales, partidas del RNP y documentos académicos para hondureños en España. El trámite se hace ante las autoridades hondureñas competentes; el Consulado no sustituye la apostilla. Le indicamos qué documentos necesita y en qué orden suelen obtenerse.',
      subservicios: [
        ...
        { titulo: 'Antecedentes penales', descripcion: 'Solicitud en Honduras y cancelación de antecedentes en España.', aliases: ['certificados de antecedentes'] },
      ...
      { titulo: 'Certificaciones de Estudios y Títulos de Educación Media', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['educación media'] },
      { titulo: 'Certificados del Registro Nacional de las Personas (RNP)', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['certificados del registro'] },
    ],
      faqs: [
    ...
    },
    {
      ...
      color: 'accent',
      respuestaDirecta:
        'Pineda y Asociados coordina poderes, compraventas, trámites bancarios, herencias, autorizaciones de viaje, reconocimientos de paternidad, matrimonios y uniones de hecho para quien reside en España y necesita actuar en Honduras. Muchos actos se otorgan por poder, sin viajar. El instrumento concreto depende del acto y de la notaría o registro competente.',
      subservicios: [
        ...
        { titulo: 'Poder para trámites bancarios', descripcion: 'En Honduras, desde España.', aliases: ['trámites bancarios a'] },
        { titulo: 'Poder para sucesión', descripcion: 'Aceptación de herencia y partición.' },
        { titulo: 'Poder para venta de inmuebles', descripcion: 'Coordinación notarial en Honduras.', aliases: ['gestión a distancia'] },
      ...
      { titulo: 'Redacción y formalización de Poderes Especiales y Generales para que un familiar o…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['redacción y formalización'] },
      { titulo: 'Cobro y aceptación de herencias, legados y partición de bienes familiares en Honduras…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['cobro y aceptación'] },
      { titulo: 'Autorizaciones de viaje a distancia para menores de edad (permisos de salida de…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['autorizaciones de viaje'] },
      { titulo: 'Reconocimientos de paternidad internacionales tramitados a distancia ante el RNP de…', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['reconocimientos de paternidad'] },
      { titulo: 'Matrimonios civiles gestionados o preparados para la comunidad en el exterior', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['matrimonios civiles gestionados'] },
      { titulo: 'Unión de hecho formalizada o tramitada a distancia', descripcion: 'Trámite o defensa según el caso. Evaluación inicial confidencial.', aliases: ['unión de hecho'] },
    ],
      faqs: [
    ...
    },
    {
      ...
      color: 'warning',
      respuestaDirecta:
        'Pineda y Asociados tramita divorcios, alimentos internacionales, custodia, sucesiones e inscripción consular de matrimonios e hijos para hondureños que viven en España. La representación en Honduras puede hacerse por poder. La jurisdicción y el convenio aplicable se confirman según dónde residan las partes y qué se pretenda obtener.',
      subservicios: [
        { titulo: 'Divorcio internacional Honduras-España', descripcion: 'Mutuo acuerdo o contencioso, según la jurisdicción más favorable.', aliases: ['tramitación completa'] },
        ...
        { titulo: 'Ejecución de alimentos en Honduras', descripcion: 'Cuando el obligado reside en España.', aliases: ['alimentos internacionales'] },
        ...
        { titulo: 'Doble nacionalidad Honduras-España', descripcion: 'Compatibilidad y renuncia.', aliases: ['asesoría legal para'] },
